---
title: 'Writing Custom Asset Importers in the Prowl Pipeline'
sidebarTitle: 'Asset Importers'
description: 'Create custom asset importers for new file types in Prowl by extending ScriptedImporter, registering via ImporterAttribute, and serializing assets.'
---
