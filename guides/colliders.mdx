---
title: 'Colliders: Shapes and Triggers in Prowl'
...
The base `Collider` class exposes two shared offset properties:
...
<Note>
`WheelCollider` is marked experimental. The forward-friction and torque feedback code paths are partially commented out in the source while the model is being refined.
</Note>
