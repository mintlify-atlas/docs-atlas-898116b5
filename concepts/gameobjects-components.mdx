---
title: 'GameObjects and Components in Prowl Engine'
sidebarTitle: 'GameObjects'
description: 'Understand Prowl's entity-component model: GameObjects are scene entities composed of MonoBehaviour components that define their behaviour.'
---
...
go.Transform.localEulerAngles = new System.Numerics.Vector3(0, 90, 0);
...
// Check whether a field has been overridden locally
bool overridden = link.HasChange(go, nameof(go.Name));
```
