---
title: 'Scene Management and Lifecycle in the Prowl Engine'
...
`SceneManager.ForeachComponent` is a public helper used internally by the engine — and usable from your own systems — to iterate all `enabledInHierarchy` components across a set of `GameObject`s:
