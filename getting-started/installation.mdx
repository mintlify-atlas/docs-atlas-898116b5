---
title: 'Prowl Game Engine — Getting Started: Installation'
sidebarTitle: 'Installation'
description: 'Step-by-step guide to install the .NET 9 SDK, clone the Prowl repository, initialize submodules, and build and run the editor on Windows, Linux, or macOS.'
---
