---
title: 'Physics API — Raycasting and Layer Collisions in Prowl'
sidebarTitle: 'Physics'
description: 'Reference for Prowl's Physics class: all Raycast overloads, the layer collision matrix, PhysicsSetting configuration, and access to the Jitter2 World.'
---
