---
title: 'Math Library Reference — Vectors, Quaternions, and Utilities'
sidebarTitle: 'Math'
description: 'Reference for Prowl's math library: double/float Vector types, Quaternion, Matrix4x4, Ray, Bounds, Rect, Transform, and Mathf/MathD utilities.'
---
...
| `LookRotation(fwd, up)` | static | Rotation looking along `fwd` |
...
| `CreateLookAt(pos, target, up)` | Left-handed look-at view matrix |
| `CreateLookAtRightHanded(pos, target, up)` | Right-handed look-at |
| `CreateLookTo(pos, dir, up)` | Look-towards view matrix |
...
| `Decompose(out scale, out rot, out trans)` | Decomposes into TRS components |
...
| `Lerp(a, b, t)` | Linear interpolation (scalar, Vector2, Vector3, Vector4 overloads) |
