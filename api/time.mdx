---
title: 'Time API — Frame Timing and Timestep Control'
sidebarTitle: 'Time'
description: 'Reference for Prowl's static Time class: all timing properties including deltaTime, fixedDeltaTime, timeScale, frameCount, and smoothDeltaTime.'
---
