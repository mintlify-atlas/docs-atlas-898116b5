---
title: 'Input API — Keyboard, Mouse, and Handler Stack in Prowl'
sidebarTitle: 'Input'
description: 'Reference for Prowl's Input class: query keyboard and mouse state, control cursor visibility, access clipboard, and manage the input handler stack.'
---
...
<ResponseField name="IsAnyKeyDown" type="bool">
