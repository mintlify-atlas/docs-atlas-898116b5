---
title: 'AudioSystem API — Play and Manage Game Audio in Prowl'
sidebarTitle: 'Audio System'
description: 'Reference for Prowl's AudioSystem class: initialize OpenAL, play audio clips with 3D positioning, manage audio pools, and control ActiveAudio handles.'
---
