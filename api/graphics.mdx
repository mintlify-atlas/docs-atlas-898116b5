---
title: 'Graphics API — Draw, Blit, and GPU Resource Control'
sidebarTitle: 'Graphics'
description: 'Reference for Prowl's Graphics class: access the Veldrid device, draw meshes, blit textures, submit command buffers, and manage GPU resources.'
---
