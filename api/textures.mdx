---
title: 'Textures API — Texture2D and RenderTexture in Prowl'
sidebarTitle: 'Textures'
description: 'Reference for Prowl's Texture2D, RenderTexture, and TextureSampler: create GPU textures, upload pixel data, read back pixels, and use the RT pool.'
---
