---
title: 'Debug API — Logging, Gizmos, and Diagnostics in Prowl'
sidebarTitle: 'Debug'
description: 'Reference for Prowl's Debug class: log messages, warnings, errors, and exceptions to the editor console, plus gizmo drawing for scene-view overlays.'
---
